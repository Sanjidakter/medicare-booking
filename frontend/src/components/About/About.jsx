    ...
    <section>
      <div className="container">
        <div className="flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
          ...
          {/*========= about content =================  */}
          <div className="w-full lg:w-a/2 xl:w-[670px] order-1 lg:order-2">
            ...
            <p className="text__para mt-[30px]">
              ...
              we can do tomorrow. Providing the best. Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi, soluta.
            </p>

            <Link to="/">
            <button className="btn text-sm">Learn More</button>
            </Link>
          </div>
        </div>
      </div>
